...
class sut(object):
    ...
    def act1(self):
        ...
        '''
        self.__test.append(('''// Test adding a student ''',self.guard1,self.act1))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test adding a student '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard2(self):
        '''
        add_student : (string, string, int, string)
        '''
        return (add_student : (string, string, int, string))
    
    def act3(self):
        '''
        // Test updating student information
        '''
        self.__test.append(('''// Test updating student information ''',self.guard3,self.act3))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test updating student information '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard4(self):
        '''
        update_student : (string, string?, int?, string?)
        '''
        return (update_student : (string, string?, int?, string?))
    
    def act5(self):
        '''
        // Test deleting a student
        '''
        self.__test.append(('''// Test deleting a student ''',self.guard5,self.act5))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test deleting a student '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard6(self):
        ...
        '''
        return (delete_student : (string))
    
    def act7(self):
        '''
        // Test searching for students
        '''
        self.__test.append(('''// Test searching for students ''',self.guard7,self.act7))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test searching for students '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act8(self):
        ...
        any
        '''
        self.__test.append(('''any ''',self.guard8,self.act8))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''any '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard8(self):
        ...
        '''
        return (search_student : (string))
    
    def act9(self):
        '''
        // Test calculating GPA
        '''
        self.__test.append(('''// Test calculating GPA ''',self.guard9,self.act9))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test calculating GPA '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act10(self):
        ...
        any
        '''
        self.__test.append(('''any ''',self.guard10,self.act10))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def guard10(self):
        '''
        calculate_gpa : (string)
        '''
        return (calculate_gpa : (string))
    
    def act11(self):
        '''
        // Test displaying student details
        '''
        self.__test.append(('''// Test displaying student details ''',self.guard11,self.act11))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test displaying student details '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard12(self):
        '''
        display_student_details : (string)
        '''
        return (display_student_details : (string))
    
    def act13(self):
        '''
        // Test generating student reports
        '''
        self.__test.append(('''// Test generating student reports ''',self.guard13,self.act13))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test generating student reports '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard14(self):
        ...
        '''
        return (generate_student_reports :)
    
    def act15(self):
        '''
        // Test marking attendance
        '''
        self.__test.append(('''// Test marking attendance ''',self.guard15,self.act15))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test marking attendance '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard16(self):
        '''
        mark_attendance : (string, string)
        '''
        return (mark_attendance : (string, string))
    
    def act17(self):
        '''
        // Test calculating average test scores
        '''
        self.__test.append(('''// Test calculating average test scores ''',self.guard17,self.act17))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test calculating average test scores '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act18(self):
        ...
        any
        '''
        self.__test.append(('''any ''',self.guard18,self.act18))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def guard18(self):
        '''
        calculate_average_test_scores :
        '''
        return (calculate_average_test_scores :)
    ...
    # END INITIALIZATION CODE
        self.__SUTName = """StudentRecordSystem"""
        self.__actions = []
        self.__names = {}
        ...
        self.__actionClasses.append('''// Test adding a student ''')
        self.__actionClasses.append('''add_student : (string, string, int, string) -> none ''')
        self.__actionClasses.append('''// Test updating student information ''')
        self.__actionClasses.append('''update_student : (string, string?, int?, string?) -> none ''')
        self.__actionClasses.append('''// Test deleting a student ''')
        self.__actionClasses.append('''delete_student : (string) -> none ''')
        self.__actionClasses.append('''// Test searching for students ''')
        self.__actionClasses.append('''search_student : (string) -> any ''')
        self.__actionClasses.append('''// Test calculating GPA ''')
        self.__actionClasses.append('''calculate_gpa : (string) -> any ''')
        self.__actionClasses.append('''// Test displaying student details ''')
        self.__actionClasses.append('''display_student_details : (string) -> none ''')
        self.__actionClasses.append('''// Test generating student reports ''')
        self.__actionClasses.append('''generate_student_reports : -> none ''')
        self.__actionClasses.append('''// Test marking attendance ''')
        self.__actionClasses.append('''mark_attendance : (string, string) -> none ''')
        self.__actionClasses.append('''// Test calculating average test scores ''')
        self.__actionClasses.append('''calculate_average_test_scores : -> any ''')
        self.__dependencies = {}
        self.__dependencies['''include "main.py" '''] = []
        self.__dependencies['''// Test adding a student '''] = []
        self.__dependencies['''add_student : (string, string, int, string) -> none '''] = []
        self.__dependencies['''// Test updating student information '''] = []
        self.__dependencies['''update_student : (string, string?, int?, string?) -> none '''] = []
        self.__dependencies['''// Test deleting a student '''] = []
        self.__dependencies['''delete_student : (string) -> none '''] = []
        self.__dependencies['''// Test searching for students '''] = []
        self.__dependencies['''search_student : (string) -> any '''] = []
        self.__dependencies['''// Test calculating GPA '''] = []
        self.__dependencies['''calculate_gpa : (string) -> any '''] = []
        self.__dependencies['''// Test displaying student details '''] = []
        self.__dependencies['''display_student_details : (string) -> none '''] = []
        self.__dependencies['''// Test generating student reports '''] = []
        self.__dependencies['''generate_student_reports : -> none '''] = []
        self.__dependencies['''// Test marking attendance '''] = []
        self.__dependencies['''mark_attendance : (string, string) -> none '''] = []
        self.__dependencies['''// Test calculating average test scores '''] = []
        self.__dependencies['''calculate_average_test_scores : -> any '''] = []
        self.__orderings = {}
        self.__okExcepts = {}
        self.__preCode = {}
        self.__refCode = {}
        ...
        self.__actions.append(('''// Test adding a student ''',self.guard1,self.act1))
        self.__names['''// Test adding a student '''] = ('''// Test adding a student ''',self.guard1,self.act1)
        self.__actionClass['''// Test adding a student '''] = '''// Test adding a student '''
        self.__orderings['''// Test adding a student '''] = 2
        self.__okExcepts['''// Test adding a student '''] = ''''''
        
        self.__actions.append(('''none ''',self.guard2,self.act2))
        self.__names['''none '''] = ('''none ''',self.guard2,self.act2)
        self.__actionClass['''none '''] = '''add_student : (string, string, int, string) -> none '''
        self.__orderings['''none '''] = 3
        self.__okExcepts['''none '''] = ''''''
        
        self.__actions.append(('''// Test updating student information ''',self.guard3,self.act3))
        self.__names['''// Test updating student information '''] = ('''// Test updating student information ''',self.guard3,self.act3)
        self.__actionClass['''// Test updating student information '''] = '''// Test updating student information '''
        self.__orderings['''// Test updating student information '''] = 4
        self.__okExcepts['''// Test updating student information '''] = ''''''
        
        self.__actions.append(('''none  ''',self.guard4,self.act4))
        self.__names['''none  '''] = ('''none  ''',self.guard4,self.act4)
        self.__actionClass['''none  '''] = '''update_student : (string, string?, int?, string?) -> none '''
        self.__orderings['''none  '''] = 5
        self.__okExcepts['''none  '''] = ''''''
        self.__refCode['''none  '''] = []
        self.__refCode['''none  '''].append('''none ''')
        
        self.__actions.append(('''// Test deleting a student ''',self.guard5,self.act5))
        self.__names['''// Test deleting a student '''] = ('''// Test deleting a student ''',self.guard5,self.act5)
        self.__actionClass['''// Test deleting a student '''] = '''// Test deleting a student '''
        self.__orderings['''// Test deleting a student '''] = 6
        self.__okExcepts['''// Test deleting a student '''] = ''''''
        
        self.__actions.append(('''none   ''',self.guard6,self.act6))
        self.__names['''none   '''] = ('''none   ''',self.guard6,self.act6)
        self.__actionClass['''none   '''] = '''delete_student : (string) -> none '''
        self.__orderings['''none   '''] = 7
        self.__okExcepts['''none   '''] = ''''''
        self.__refCode['''none   '''] = []
        self.__refCode['''none   '''].append('''none ''')
        
        self.__actions.append(('''// Test searching for students ''',self.guard7,self.act7))
        self.__names['''// Test searching for students '''] = ('''// Test searching for students ''',self.guard7,self.act7)
        self.__actionClass['''// Test searching for students '''] = '''// Test searching for students '''
        self.__orderings['''// Test searching for students '''] = 8
        self.__okExcepts['''// Test searching for students '''] = ''''''
        
        self.__actions.append(('''any ''',self.guard8,self.act8))
        self.__names['''any '''] = ('''any ''',self.guard8,self.act8)
        self.__actionClass['''any '''] = '''search_student : (string) -> any '''
        self.__orderings['''any '''] = 9
        self.__okExcepts['''any '''] = ''''''
        
        self.__actions.append(('''// Test calculating GPA ''',self.guard9,self.act9))
        self.__names['''// Test calculating GPA '''] = ('''// Test calculating GPA ''',self.guard9,self.act9)
        self.__actionClass['''// Test calculating GPA '''] = '''// Test calculating GPA '''
        self.__orderings['''// Test calculating GPA '''] = 10
        self.__okExcepts['''// Test calculating GPA '''] = ''''''
        
        self.__actions.append(('''any  ''',self.guard10,self.act10))
        self.__names['''any  '''] = ('''any  ''',self.guard10,self.act10)
        self.__actionClass['''any  '''] = '''calculate_gpa : (string) -> any '''
        self.__orderings['''any  '''] = 11
        self.__okExcepts['''any  '''] = ''''''
        self.__refCode['''any  '''] = []
        self.__refCode['''any  '''].append('''any ''')
        
        self.__actions.append(('''// Test displaying student details ''',self.guard11,self.act11))
        self.__names['''// Test displaying student details '''] = ('''// Test displaying student details ''',self.guard11,self.act11)
        self.__actionClass['''// Test displaying student details '''] = '''// Test displaying student details '''
        self.__orderings['''// Test displaying student details '''] = 12
        self.__okExcepts['''// Test displaying student details '''] = ''''''
        
        self.__actions.append(('''none    ''',self.guard12,self.act12))
        self.__names['''none    '''] = ('''none    ''',self.guard12,self.act12)
        self.__actionClass['''none    '''] = '''display_student_details : (string) -> none '''
        self.__orderings['''none    '''] = 13
        self.__okExcepts['''none    '''] = ''''''
        self.__refCode['''none    '''] = []
        self.__refCode['''none    '''].append('''none ''')
        
        self.__actions.append(('''// Test generating student reports ''',self.guard13,self.act13))
        self.__names['''// Test generating student reports '''] = ('''// Test generating student reports ''',self.guard13,self.act13)
        self.__actionClass['''// Test generating student reports '''] = '''// Test generating student reports '''
        self.__orderings['''// Test generating student reports '''] = 14
        self.__okExcepts['''// Test generating student reports '''] = ''''''
        
        self.__actions.append(('''none     ''',self.guard14,self.act14))
        self.__names['''none     '''] = ('''none     ''',self.guard14,self.act14)
        self.__actionClass['''none     '''] = '''generate_student_reports : -> none '''
        self.__orderings['''none     '''] = 15
        self.__okExcepts['''none     '''] = ''''''
        self.__refCode['''none     '''] = []
        self.__refCode['''none     '''].append('''none ''')
        
        self.__actions.append(('''// Test marking attendance ''',self.guard15,self.act15))
        self.__names['''// Test marking attendance '''] = ('''// Test marking attendance ''',self.guard15,self.act15)
        self.__actionClass['''// Test marking attendance '''] = '''// Test marking attendance '''
        self.__orderings['''// Test marking attendance '''] = 16
        self.__okExcepts['''// Test marking attendance '''] = ''''''
        
        self.__actions.append(('''none      ''',self.guard16,self.act16))
        self.__names['''none      '''] = ('''none      ''',self.guard16,self.act16)
        self.__actionClass['''none      '''] = '''mark_attendance : (string, string) -> none '''
        self.__orderings['''none      '''] = 17
        self.__okExcepts['''none      '''] = ''''''
        self.__refCode['''none      '''] = []
        self.__refCode['''none      '''].append('''none ''')
        
        self.__actions.append(('''// Test calculating average test scores ''',self.guard17,self.act17))
        self.__names['''// Test calculating average test scores '''] = ('''// Test calculating average test scores ''',self.guard17,self.act17)
        self.__actionClass['''// Test calculating average test scores '''] = '''// Test calculating average test scores '''
        self.__orderings['''// Test calculating average test scores '''] = 18
        self.__okExcepts['''// Test calculating average test scores '''] = ''''''
        
        self.__actions.append(('''any   ''',self.guard18,self.act18))
        self.__names['''any   '''] = ('''any   ''',self.guard18,self.act18)
        self.__actionClass['''any   '''] = '''calculate_average_test_scores : -> any '''
        self.__orderings['''any   '''] = 19
        self.__okExcepts['''any   '''] = ''''''
        self.__refCode['''any   '''] = []
        self.__refCode['''any   '''].append('''any ''')
